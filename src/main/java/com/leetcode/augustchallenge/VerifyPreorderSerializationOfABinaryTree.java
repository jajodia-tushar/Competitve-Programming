...
public class VerifyPreorderSerializationOfABinaryTree {
    ...
    public static void main(String[] args) {
        ...
        boolean result = obj.isValidSerialization(input);
...
/*
    The Idea to Solve this Question is Amazing.
    The Concept of InDegree and OutDegree.
    ...
    between out degree and in degree diff = OutDegree - InDegree.
    When the next node comes, we then decrease diff by 1,
    because the node provides an in degree.
    If the node is not null, we increase diff by 2,
